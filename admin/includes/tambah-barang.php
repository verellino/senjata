<div class="container mt-5">
  ...
  <form action="proses/proses-tambah-barang.php" method="POST" class="mt-3" autocomplete="off">
    <div class="form-group">
      <label for="nama_barang">Nama Senjata</label>
      <input type="text" name="nama_barang" placeholder="Senjata" class="form-control" autofocus required>
    </div>

    <div class="row">
      <div class="col-md-4">
 <div class="form-group">
   <label for="jenis">Jenis Senjata</label>
   <input type="text" name="jenis" class="form-control" required placeholder="Jenis">
 </div>
      </div>
      <div class="col-md-4">
 <div class="form-group">
 ...
 <div class="form-group">
   ...
   <input type="text" name="ruang" class="form-control" required placeholder="Contoh: Gudang">
    ...
    <div class="row">
      <div class="col-md-4">
 <div class="form-group">
   <label for="jenis">Kondisi Senjata</label>
